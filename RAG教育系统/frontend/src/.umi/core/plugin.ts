...
import * as Plugin_0 from 'C:/Users/97196/Downloads/extra_kg_chat (3) (1)/my-umi-app/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/Users/97196/Downloads/extra_kg_chat (3) (1)/my-umi-app/src/app.tsx',
    },
    {
      apply: Plugin_1,
